...
impl Plugin for HelloPlugin {
    ...
    fn middleware(&self) -> Option<fn(Request<axum::body::Body>, Next) -> futures::future::BoxFuture<'static, Result<Response<Body>, StatusCode>>> {
        Some(|mut req: Request<Body>, next: Next| Box::pin(async move{
            let token_opt = req
        .headers()
        .get("Authorization")
